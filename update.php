...
$sql="UPDATE `aluminidata` SET `Firstname`='$Fname',`Lastname`='$Lname',`Dob`='$dob',`Email`='$email',`Batch`='$batch',`Department`='$dept',`Status`='$status',`clgorcmpname`='$clgname',`Currentlocation`='$location',`Mobileno`='$mobileno',`Address`='$Address' WHERE `Firstname`='$n'";
...
<html>
    ...
    <body  >
       ...
       <div style='width:700px; font-size:20px;margin-left:330px;font-family:serif;margin-top:-20px;'>
        <form method="post" action=""> 
       <h2>Update:</h2><table style='border-spacing:10px;font-size:20px;color:rgb(23, 33, 111);font-family: serif;padding:5px;'><tr><td><b>Firstname:</b></td><td><input type="text" name="Fname" required></td><td><b>Lastname:</b></td><td><input type="text" name="Lname" required></td></tr>
       ...
       <tr><td><b>Address:</b></td><td><textarea name="Address" required></textarea></td></tr><table>
       <button  style='cursor:pointer;background-color:rgb(10, 10, 110);color:white;width:80px;height:40px;border-radius:2px;' name="Submit" onclick="alert('Successfully Updated')">Update</button><button  style='cursor:pointer;background-color:rgb(10, 10, 110);color:white;width:80px;height:40px;border-radius:2px;margin-left:20px;'><a style='text-decoration:none;color:white;' href='profile.php'>Back</a></button>
    </form>   
    </div></body></html>
