...
<div class="main" >
          ...
          <h3 class="welname"><a href="profile.php"><img style="margin-right:10px;vertical-align: middle;" src="icons\icons8-test-account-100.png"><?php  include 'conn.php';  echo $row["Firstname"]." ".$row["Lastname"];?></a></h3> 
    </div>
    <div class="menu">
  ...
  <ul class="navbar__menu">
    <li class="navbar__item">
      <a href="dashboard.php" class="navbar__link"><i data-feather="home"></i><span>Dashboard</span></a>
    </li>
    <li class="navbar__item1">
      <i data-feather="message-square"></i><span>Alumni Services</span>
      <ul>
        <li class="navbar__itemsub">
            <a href="campvisit.php" class="navbar__link"><i data-feather="home"></i><span>Request campus visit </span></a>
        </li>
        <li class="navbar__itemsub">
            <a href="query.php" class="navbar__link"><i data-feather="home"></i><span>Raise a Query</span></a>
        </li>

      </ul>        
    </li>
    <li class="navbar__item">
      <a href="gallery.php" class="navbar__link"><i data-feather="users"></i><span>Gallery</span></a>        
    </li>
    <li class="navbar__item">
      <a href="fund.php" class="navbar__link"><i data-feather="folder"></i><span>Funding</span></a>        
    </li>
    <li class="navbar__item">
      <a href="contact.php" class="navbar__link"><i data-feather="archive"></i><span>Members</span></a>        
    </li>
    <li class="navbar__item">
      <a href="profile.php" class="navbar__link"><i data-feather="help-circle"></i><span>Profile</span></a>        
    </li>
    <li class="navbar__item">
